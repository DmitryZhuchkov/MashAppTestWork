...
struct Datum: Codable {
    let id: Int
    let address: String
    let isStaylisted: Bool
    let latitude, longitude: Double
    let image: String
    let stars, reviewsCount: Int
    let reviewsScore: Double
    let reviewsScoreWord: ReviewsScoreWord
    let price, priceNight, rewardAmount: Double
    let rewardPercent: Int
    let tax: Double
    let video: [JSONAny]
    let freeCancellation, prepayment: Bool
...
enum ReviewsScoreWord: String, Codable {
